...
export const HowToBuyContent = () => (
    <ol className="list-decimal list-inside space-y-3">
      <li>
        <span className="font-bold text-violet-400">Connect Your Wallet:</span>
        <p className="pl-2">Click “Connect Wallet” in the right-side panel and link your preferred wallet (e.g., MetaMask, WalletConnect).</p>
      </li>
      <li>
        <span className="font-bold text-violet-400">Browse NFTs:</span>
        <p className="pl-2">Use the category, rarity, and genre filters to explore available NFTs.</p>
      </li>
      <li>
        <span className="font-bold text-violet-400">View Details:</span>
        <p className="pl-2">Click any NFT card to open its details modal, showing rarity, history, and price.</p>
      </li>
      <li>
        <span className="font-bold text-violet-400">Buy the NFT:</span>
        <p className="pl-2">Click “Buy Now” and confirm the transaction using your connected wallet.</p>
      </li>
      <li>
        <span className="font-bold text-violet-400">Transaction Confirmation:</span>
        <p className="pl-2">Wait for the transaction to complete — this may take a few seconds depending on the network.</p>
      </li>
      <li>
        <span className="font-bold text-violet-400">NFT Delivery:</span>
        <p className="pl-2">Once confirmed, the NFT will appear instantly in your Profile → Inventory tab.</p>
      </li>
      <li>
        <span className="font-bold text-violet-400">Cooldown Period:</span>
        <p className="pl-2">Newly purchased NFTs are automatically placed under the 7-day cooldown before they can be traded or merged.</p>
      </li>
    </ol>
  );
