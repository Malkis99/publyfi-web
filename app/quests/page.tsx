...
import QuestsFooter from '@/components/quests/footer/QuestsFooter';
...
const QuestsPage = () => {
  ...
  return (
    <main className="relative min-h-screen bg-[#140f22] text-gray-200">
      ...
      <div className="relative z-10 w-full">
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 lg:grid-cols-[1fr_minmax(0,2fr)_1fr] gap-8 items-start">
