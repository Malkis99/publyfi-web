...
*   Marketplace & Quests: fees on every transaction + incentive for users to buy and spend PUBL.
...
**Answer:**
*   Runs on Immutable zkEVM for scalability, low gas fees, and Ethereum-level security.
*   Multichain bridges (Polygon, Solana, BNB) planned for expansion.
*   Microservices architecture allows modular updates without downtime.
*   Unity-based front-end supports browser, mobile, and future console deployment.

## 9. How do you protect user data and assets?
**Answer:**
*   Non-custodial wallets by default — users fully own their assets.
...
**Answer:**
*   Initial 5 core members cover tech, product, design, and ops.
*   Hiring plan to grow to 12–15 members post-pre-seed (engineering, community, marketing).
*   Agile development cycles (biweekly sprints) ensure roadmap remains on track.