...
const MenuButton = () => {
  ...
  return (
    <button
      onClick={toggleMenu}
      className={`fixed top-4 left-4 z-50 p-2 rounded-full text-white focus:outline-none group transition-all duration-300 ease-in-out hover:scale-110 ${isOpen ? 'hidden' : ''}`}
